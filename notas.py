...
if a ==("c") or a == ("C"):
    ...
    print ("O campo harmônico maior de C é C - Dm - Em - F - G - Am - B°")
    
elif a ==("g") or a == ("G"):
    print ("A escala maior de G é G - A - B - C - D - E - F#")
    print ("O campo harmônico maior de G é G - Am - Bm - C - D - Em - F#°")
    
elif a ==("d") or a == ("D"):
    print ("A escala maior de D é D - E - F# - G - A - B - C#")
    print ("O campo harmônico maior de D é D - Em - F#m - G - A - Bm - C#°")
    
elif a ==("a") or a == ("A"):
    print ("A escala maior de A é A - B - C# - D - E - F# - G#")
    print ("O campo harmônico maior de A é A - Bm - C#m - D - E - F#m - G#°")
